...
${BRAND_BASE}
  ...
  .status-err { background:var(--err-soft); color:var(--err-strong); }
  ...
  .detail-row .v { color:var(--text); font-weight:600; text-align:right; word-break:break-all; }
  .detail-row .v.mono {
  ...
  .btn {
    ...
    color:var(--on-primary); text-decoration:none; padding:12px 24px; border-radius:8px;
    font-size:14px; font-weight:600; transition:background .15s, border-color .15s, color .15s;
  }
  .btn:hover { background:var(--primary-hover); }
  .btn-ghost { background:transparent; color:var(--text-secondary); border:1px solid var(--border-control); }
